// ===========================================
// INICIALIZADOR DO SISTEMA PLANETÁRIO - VERSÃO X3
// ===========================================
// Este ficheiro inicializa a aplicação de Realidade Aumentada para a versão X3 do sistema
...
async function initPlanets() {
  try {
    // Carrega o ficheiro JSON com os dados do sistema planetário X3
    const response = await fetch('../data/SystemDataX3.json');
